...
if  __name__ == '__main__':
        ...
        print('capital total ', capital_total, ' in dict ', capital_dict, ' correct ', float(capital_correct)/capital_dict)
        print('state total ',state_total, ' in dict ', state_dict, ' correct ', float(state_correct)/state_dict)
        print('family total ',family_total, ' in dict ', family_dict, ' correct ',float(family_correct)/family_dict)
        print(' total ', total,' indict ',indict, ' correct ',float(correct)/indict)
